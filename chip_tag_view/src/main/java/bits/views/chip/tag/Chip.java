...
import static bits.views.chip.tag.ChipUtils.generateText;
import static bits.views.chip.tag.ChipUtils.getCircleBitmap;
import static bits.views.chip.tag.ChipUtils.getCircleBitmapWithText;
import static bits.views.chip.tag.ChipUtils.getScaledBitmap;
import static bits.views.chip.tag.ChipUtils.getSquareBitmap;
import static bits.views.chip.tag.ChipUtils.setIconColor;
